-- =====================================================
-- Refunds Table & Process Refund Atomic Update
-- Created: 2026-08-13
-- Description:
--   1. Creates a dedicated refunds table to store all refund data
--   2. Updates process_refund_atomic to:
--      - Insert into refunds table
--      - Update orders.payment_status to 'refunded'
--      - Void the associated invoice
-- =====================================================
