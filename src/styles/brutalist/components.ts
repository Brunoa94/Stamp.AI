...
export const brutalistComponents = {
  ...
  productCard: {
    ...
    title: "font-(family-name:--font-outfit) text-lg uppercase leading-tight",
  ...
  processCard: {
    ...
    number: "font-(family-name:--font-outfit) text-4xl opacity-20 group-hover:opacity-100 transition-opacity",
    content: "relative z-10",
    title: "font-(family-name:--font-outfit) text-3xl mb-3 uppercase tracking-tight",
  ...
  valueCard: {
    ...
    icon: "text-3xl mb-4",
    title: "font-(family-name:--font-outfit) text-2xl uppercase mb-2",
  ...
  testimonialCard: {
    ...
    author: "font-(family-name:--font-outfit) text-xl tracking-tight uppercase group-hover:text-brandCyan transition-colors",
  ...
  faqAccordion: {
    ...
    summary: "flex justify-between items-center cursor-pointer list-none font-(family-name:--font-outfit) text-2xl uppercase tracking-tight",
  ...
  sectionHeader: {
    ...
    title: "font-(family-name:--font-outfit) text-6xl md:text-7xl lg:text-8xl xl:text-9xl leading-none uppercase tracking-tighter",
    subtitle: "text-xs tracking-widest font-bold opacity-30 uppercase",
  },

  // CTA buttons
  cta: {
    primary: "px-12 py-6 bg-gradient-to-r from-brandPurple to-brandCyan font-(family-name:--font-outfit) text-xl uppercase tracking-widest hover:scale-105 transition-transform text-center text-white",
    secondary: "px-12 py-6 border-2 border-white font-(family-name:--font-outfit) text-xl uppercase tracking-widest hover:bg-white hover:text-ink transition-all text-center",
    stampIt: "cta-gradient-border bg-ink px-12 py-3.5 font-(family-name:--font-outfit) text-xl tracking-widest uppercase hover:scale-110 transition-all duration-300 rounded-none shadow-[8px_8px_0px_rgba(10,10,10,0.1)] text-white",
  },
} as const;
