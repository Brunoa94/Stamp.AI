...
export function AuthenticatedUserSection({ user }: PropsI) {
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      {/* Dashboard button */}
      <Button asChild size="sm" className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white shadow-md hover:shadow-lg hover:shadow-purple-500/30 transition-all duration-300 hover:scale-105">
        <Link href="/dashboard">
