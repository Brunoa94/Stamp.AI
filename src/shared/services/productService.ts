...
import type { CreatedProductT } from "@/shared/types/customProduct";
import { ProductServiceMapper, type SavePrintifyProductInput } from "@/shared/mappers/services/productServiceMapper";
