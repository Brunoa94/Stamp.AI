...
import { ImageGenerationResponseSchema } from "@/shared/schemas/services/imageGenerationServiceSchemas";
import {
  type ImageGenerationRequestPayload,
  ImageGenerationServiceMapper,
} from "@/shared/mappers/services/imageGenerationServiceMapper";
...
export class ImageGenerationService {
  static async generateImage(
    ...
    try {
      ...
      return ImageGenerationServiceMapper.mapResponseToResult(
        validatedResponse,
      );
    } catch (error) {
