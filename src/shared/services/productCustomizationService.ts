import { CatalogBlueprintsResponseSchema } from "@/shared/schemas/services/productCustomizationServiceSchemas";
import { BlueprintVariantsResponseSchema } from "@/shared/schemas/printify";
import { z } from "zod";
  ...
  static async fetchCatalogBlueprints(): Promise<CatalogBlueprintsResponse> {
    try {
      ...
      if (!validatedData.success) {
        throw new Error(
          validatedData.error || "Failed to fetch catalog blueprints",
        );
      }
      ...
      throw ErrorClient.handleError({
        ...
        action: "Fetch Catalog Blueprints",
      });
    }
  }
  ...
  static async fetchBlueprintVariants(
    ...
    try {
      ...
      throw ErrorClient.handleError({
        error,
        service: "Product Customization",
        action: "Fetch Blueprint Variants",
      });
    }
  }
}
