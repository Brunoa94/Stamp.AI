...
import { CatalogQueryService } from "@/shared/services/catalogQueryService";
import type {
  CatalogProduct,
  CatalogProductWithSeo,
} from "@/shared/services/catalogQueryService";
 ...
 */
export function useCatalogProductsWithSeo(): UseQueryResult<
  CatalogProductWithSeo[]
> {
  return useQuery({
 ...
 */
export function useProductOfMonth(): UseQueryResult<
  CatalogProductWithSeo | null
> {
  return useQuery({
