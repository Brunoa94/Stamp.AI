export const navbarDesignSystem = {
  ...
  actions: {
    ...
    cartButton: `relative h-10 w-10 rounded-full border border-black/10 bg-white/45 text-black/70 transition-all hover:bg-white/70 hover:text-black focus-visible:ring-2 focus-visible:ring-purple-500/40 dark:border-white/20 dark:bg-white/10 dark:text-white/80 dark:hover:bg-white/20 dark:hover:text-white`,
    cartIcon: `h-5 w-5`,
    cartBadge: `absolute -right-1 -top-1 h-4.5 min-w-4.5 rounded-full border border-white/70 bg-linear-to-r from-purple-600 via-pink-600 to-red-600 px-1 text-[10px] font-bold text-white shadow-[0_4px_10px_rgba(139,92,246,0.35)] flex items-center justify-center`,
