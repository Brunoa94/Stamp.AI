...
export const componentThemes = {
  ...
  footer: {
    ...
    missionText: `text-gray-600 dark:text-gray-400 text-sm leading-relaxed max-w-xs font-sans`,
    sectionTitle: `text-base font-heading font-bold uppercase tracking-tight text-gray-900 dark:text-white mb-6`,
    linkList: `space-y-3 text-sm font-sans`,
    ...
    copyright: `text-gray-500 dark:text-gray-500 text-xs font-bold uppercase tracking-widest font-sans`,
