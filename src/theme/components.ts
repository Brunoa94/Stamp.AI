...
export const componentThemes = {
  ...
  footer: {
    ...
    copyright: `text-gray-500 dark:text-gray-500 text-sm font-bold uppercase tracking-widest font-sans`,
  ...
  orders: {
    ...
    filters: {
      ...
      chipBase: `px-4 py-2 rounded-lg text-sm font-bold border border-white/60 bg-white/35 backdrop-blur-md text-slate-700 hover:border-[#06B6D4]/50 hover:bg-cyan-50/60 transition-all`,
      chipActive: `px-4 py-2 rounded-lg text-sm font-bold border border-[#7C3AED]/40 bg-[#7C3AED]/80 backdrop-blur-md text-white shadow-[0_8px_24px_-12px_rgba(124,58,237,0.7)]`,
    },
    table: {
      ...
      row: `order-row transition-colors hover:bg-[#06B6D4]/[0.05]`,
      cell: `px-8 py-8`,
      ...
      itemImage: `inline-block h-14 w-14 rounded-lg ring-2 ring-white object-cover bg-slate-100`,
      itemBadge: `inline-flex items-center justify-center h-14 w-14 rounded-lg bg-slate-800 text-white text-xs font-bold ring-2 ring-white`,
      ...
      viewButton: `px-5 py-2.5 rounded-lg text-sm font-bold text-white border border-white/45 bg-[#7C3AED]/85 backdrop-blur-md shadow-[0_10px_25px_-15px_rgba(124,58,237,0.9)] hover:brightness-110 hover:-translate-y-0.5 transition-all`,
      reorderButton: `px-5 py-2.5 rounded-lg text-sm font-bold text-slate-700 border border-white/65 bg-white/40 backdrop-blur-md hover:bg-cyan-50/60 hover:border-[#06B6D4]/40 hover:text-[#0891B2] transition-all`,
      moreActionsTrigger: `h-8 px-2.5 rounded-md border border-white/55 bg-white/35 backdrop-blur-md text-[10px] font-bold uppercase tracking-[0.14em] text-slate-500 hover:text-[#0891B2] hover:border-[#06B6D4]/40 hover:bg-cyan-50/60 transition-all`,
      ...
      moreActionsButton: `h-9 rounded-md border border-white/60 bg-white/40 backdrop-blur-md px-3 text-[11px] font-bold uppercase tracking-[0.08em] text-slate-700 hover:border-[#06B6D4]/40 hover:bg-cyan-50/60 hover:text-[#0891B2] transition-all`,
    },
    pagination: {
      ...
      button: `w-8 h-8 flex items-center justify-center rounded border border-white/60 bg-white/40 backdrop-blur-md text-slate-500 hover:text-slate-900 hover:bg-white/60 transition-all disabled:opacity-50`,
      pageButton: `w-8 h-8 flex items-center justify-center rounded border border-white/60 bg-white/40 backdrop-blur-md text-xs text-slate-600 hover:border-[#06B6D4]/45 hover:text-[#0891B2] transition-all`,
      pageButtonActive: `w-8 h-8 flex items-center justify-center rounded border border-[#7C3AED]/35 bg-[#7C3AED]/85 backdrop-blur-md text-white text-xs font-bold shadow-[0_8px_20px_-10px_rgba(124,58,237,0.7)]`,
    },
    mobileCard: {
      ...
      viewButton: `h-11 border border-white/45 bg-[#7C3AED]/85 backdrop-blur-md text-white text-[10px] font-bold rounded-lg active:scale-95 hover:brightness-110 transition-all uppercase tracking-widest`,
      reorderButton: `h-11 border border-white/60 bg-white/40 backdrop-blur-md text-slate-600 text-[10px] font-bold rounded-lg active:scale-95 hover:bg-cyan-50/60 hover:text-[#0891B2] transition-all uppercase tracking-widest`,
    },
    mobileFilters: {
      ...
      chipBase: `shrink-0 snap-start px-4 py-1.5 rounded-lg text-[10px] font-bold border border-white/60 bg-white/40 backdrop-blur-md text-slate-700`,
      chipActive: `shrink-0 snap-start px-4 py-1.5 rounded-lg text-[10px] font-bold border border-[#7C3AED]/40 bg-[#7C3AED]/85 backdrop-blur-md text-white shadow-[0_8px_20px_-12px_rgba(124,58,237,0.7)]`,
    },
    mobilePagination: {
      ...
      controls: `flex items-center gap-2`,
      navButton: `w-8 h-8 flex items-center justify-center rounded border border-white/60 bg-white/40 backdrop-blur-md text-slate-400 disabled:opacity-50`,
      pageButtonActive: `w-8 h-8 flex items-center justify-center rounded border border-[#7C3AED]/35 bg-[#7C3AED]/85 backdrop-blur-md text-white text-[10px] font-bold`,
      pageButton: `w-8 h-8 flex items-center justify-center rounded border border-white/60 bg-white/40 backdrop-blur-md text-[10px] text-slate-600`,
    },
    sideBorders: {
