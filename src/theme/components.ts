...
export const componentThemes = {
  ...
  wizardUploadArea: {
    uploadArea: {
      ...
      heading: "text-4xl font-heading mb-2 tracking-widest uppercase bg-linear-to-r from-[#1A2340] via-[#7C3AED] to-[#06B6D4] bg-clip-text text-transparent",
  ...
  orders: {
    ...
    filters: {
      ...
      timeframeLabel: `text-xs md:text-sm font-bold text-slate-600 uppercase tracking-widest whitespace-nowrap`,
      selectWrapper: `relative min-w-[160px]`,
      select: `w-full px-4 py-2.5 bg-white/50 border border-slate-400 rounded text-sm font-bold text-slate-700 focus:ring-2 focus:ring-[#7C3AED]/20 outline-none appearance-none cursor-pointer`,
      statusLabel: `text-xs md:text-sm font-bold text-slate-600 uppercase tracking-widest mr-2`,
    ...
    mobileFilters: {
      ...
      sectionLabel: `text-[10px] font-bold text-slate-600 uppercase tracking-widest block mb-2`,
      selectWrapper: `relative`,
      select: `w-full px-4 py-2 bg-white/50 border border-slate-400 rounded text-xs font-bold text-slate-700 focus:ring-2 focus:ring-[#7C3AED]/20 outline-none appearance-none cursor-pointer`,
  ...
  mobilePageHeader: {
    ...
    title: `font-heading text-[2.5rem] leading-[0.9] tracking-widest font-extrabold uppercase bg-linear-to-r from-[#1A2340] via-[#7C3AED] to-[#06B6D4] bg-clip-text text-transparent`,
