  ...
  return (
    <>
      ...
      >
        ...
        {/* Main Content Area */}
        <section className="flex-1 flex flex-col relative bg-white/10 overflow-y-auto">
          <WizardProductForm />
        </section>
      </div>
    </>
