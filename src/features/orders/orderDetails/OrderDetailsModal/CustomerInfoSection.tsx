...
export function CustomerInfoSection({ order }: Props) {
  if (!order.shipping_address && !order.billing_address && !order.customer_name) {
    return null;
  }
  ...
  return (
    <section className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h3 className={componentThemes.text.subheading}>Customer Information</h3>
      </div>
      ...
      {order.payment_method && (
        <div className="flex items-center gap-2 bg-white border border-purple-100 rounded-lg p-4">
