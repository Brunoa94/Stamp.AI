    ...
    <div className="flex flex-wrap gap-2">
      {pills.map((pill) => (
        <Span
          key={pill.key}
          unstyled
          className="inline-flex items-center gap-2 border border-(--color-stamp-divider) bg-white px-4 py-2 text-[11px] font-bold uppercase tracking-widest text-(--color-stamp-chocolate)"
        >
          {pill.label}
          <Button
