  ...
  return (
    <div className="flex flex-col items-center p-4 text-center font-heading">
      ...
      <Heading
        as="h3"
        unstyled
        className="mb-1 line-clamp-2 font-heading text-base font-bold uppercase leading-tight tracking-tight"
      >
      ...
      <div className="grid w-full grid-cols-2 gap-2">
        <Button
          ...
          variant="default"
          className="justify-center bg-(--color-stamp-chocolate) px-0 py-2 font-heading font-semibold uppercase text-[8px] tracking-[0.15em] text-(--color-stamp-white) transition-all duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-0.5 hover:bg-(--color-stamp-gold) hover:shadow-(--shadow-stamp-gold-cta)"
        >
          Track
        </Button>
        <Button
