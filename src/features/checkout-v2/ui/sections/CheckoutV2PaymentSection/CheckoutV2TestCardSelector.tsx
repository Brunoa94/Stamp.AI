...
interface CheckoutV2TestCardSelectorPropsI {
  value: string;
  onChange: (value: string) => void;
}

export function CheckoutV2TestCardSelector({
  value,
  onChange,
}: CheckoutV2TestCardSelectorPropsI) {
  return (
    <div className="space-y-3">
      <label htmlFor="test-card-select-v2">
