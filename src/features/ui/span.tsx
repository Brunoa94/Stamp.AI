...
const spanVariants = {
  ...
  label: "font-body text-[10px] font-bold uppercase tracking-[0.3em]",
  meta: "font-body text-[10px] font-bold uppercase tracking-[0.2em]",
  badge: "font-body text-[10px] font-bold uppercase tracking-[0.15em]",
  value: "font-body text-xs md:text-sm font-bold uppercase tracking-[0.15em]",
