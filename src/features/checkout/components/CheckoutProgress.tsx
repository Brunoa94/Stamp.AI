...
export const CheckoutProgress = ({
  ...
  const isStepActive = (stepNumber: number) => {
    if (stepNumber === 1) return !shippingAddress;
    if (stepNumber === 2) return !!shippingAddress && paymentStatus !== "success";
    if (stepNumber === 3) return paymentStatus === "success";
    return false;
  };
      ...
      <div className="relative">
          <div className="flex items-center justify-between relative">
            ...
            <div className="absolute top-8 left-0 right-0 h-2 -z-10 mx-12 md:mx-16">
              <div
                className="h-full bg-gradient-to-r from-purple-500 via-purple-600 to-pink-500 rounded-full shadow-lg relative overflow-hidden transition-all duration-1000 ease-in-out"
              ...
              >
                ...
                {/* Glow effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-400 blur-sm opacity-60" />
              </div>
            </div>
                ...
                >
                  ...
                  <div
                    className={clsx(
                      ...
                      {
                        // Completed state
                        "bg-gradient-to-br from-purple-500 via-purple-600 to-pink-500 text-white border-purple-400 shadow-2xl shadow-purple-400/50 scale-110 animate-[checkout-step-complete_0.6s_ease-out]":
                          isComplete,
                        // Active state
                  ...
                  >
                    {isComplete ? (
                      ...
                      <span className="text-lg md:text-xl font-extrabold">{step.number}</span>
                    )}
                  ...
                  <div className="mt-4 text-center">
                    <p
                      className={clsx("text-sm md:text-base font-bold transition-all duration-500", {
                    ...
                    <p
                      className={clsx("text-xs mt-1 transition-all duration-500 hidden md:block", {
