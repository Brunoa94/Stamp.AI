...
export default function ProductCustomizer({
  ...
  const [selectedTshirtType, setSelectedTshirtType] = useState<TshirtType | null>(null);
  ...
  const handleSubmit = () => {
    ...
    // Calculate total price including t-shirt type
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Summary & Continue */}
      {selectedCatalogBlueprint && uploadedFrontImage && selectedVariantId && selectedTshirtType && (
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="text-right">
              <p className="text-lg font-semibold">
                ${((25.0 + selectedTshirtType.price) * quantity).toFixed(2)}
              </p>
